                                ...
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        <p
                                            ...
                                            <br>
                                            <p style="color: #3d4852; display:inline-block; margin-top: 2px; margin-bottom: 2px;">Correo:</p> &nbsp;{{  $contact['email'] ?? ''  }}
                                            <br>
                                            <p style="color: #3d4852; display:inline-block; margin-top: 2px; margin-bottom: 2px;">Numero:</p> &nbsp;{{  $contact['phone'] ?? ''  }}
                                            <br>
                                            <p style="color: #3d4852; display:inline-block; margin-top: 2px; margin-bottom: 2px;">Compañia:</p> &nbsp;{{  $contact['company'] ?? ''  }}
                                        </p>
                                ...
                                <tr>
                                    <td class="content-cell" align="center"
                                        ...
                                        <p
                                            ...
                                            © {{  \Carbon\Carbon::now()->year }} {{  env('APP_NAME', 'IMAQ')  }}. All rights reserved.</p>
