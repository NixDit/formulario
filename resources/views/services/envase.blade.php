@extends('index2')
@section('title','Envase - IMAQ | Industrial Maquiladora OSC')
@section('content')
        ...
        <div class="row align-items-center justify-content-center pb-4 mb-5">
            <div class="col-lg-6 pb-sm-4 pb-lg-0 mb-5 mb-lg-0">
                <div class="overflow-hidden">
                    <h1 class="font-weight-bold text-color-dark line-height-1 mb-0 appear-animation animated maskUp appear-animation-visible" data-appear-animation="maskUp" data-appear-animation-delay="300" style="animation-delay: 300ms;">Envase</h1>
                </div>
                ...
                <p class="text-color-dark text-3-5 mb-4 appear-animation animated fadeInUpShorter appear-animation-visible" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="450" style="animation-delay: 450ms;">El envase es uno de los elementos más importantes para el éxito de los productos cosméticos, ya que debe cumplir con los requisitos estéticos, funcionales y de seguridad para atraer al consumidor y proteger el producto.</p>
                <p class="text-color-dark text-3-5 mb-4 appear-animation animated fadeInUpShorter appear-animation-visible" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="700" style="animation-delay: 700ms;">Contamos con una amplia gama de diseños de envases de cosméticos innovadores y sostenibles, nacionales e importados. Tenemos envases sostenibles y amigables con el medio ambiente, utilizando materiales reciclables y biodegradables.</p>
                <p class="text-color-dark text-3-5 mb-4 appear-animation animated fadeInUpShorter appear-animation-visible" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="700" style="animation-delay: 900ms;">Se realizan pruebas de rendimiento y seguridad para asegurarnos de que los envases sean seguros y cumplan con los estándares de calidad establecidos. </p>
            ...
            <div class="col-10 col-md-9 col-lg-6 ps-lg-5 pe-5 appear-animation animated fadeInRightShorterPlus appear-animation-visible" data-appear-animation="fadeInRightShorterPlus" data-appear-animation-delay="1450" data-plugin-options="{'accY': -200}" style="animation-delay: 1450ms;">
                <div class="position-relative">
                    <div data-plugin-float-element="" data-plugin-options="{'startPos': 'top', 'speed': 0.2, 'transition': true, 'transitionDuration': 1000, 'isInsideSVG': true}" style="top: 0px; transition: transform 1000ms ease-out 0ms; transform: translate3d(0px, 9.07284%, 0px);">
                        <img src="img/landing/services/envase.jpg" class="img-fluid border border-width-10 border-color-light rounded box-shadow-3 lazyload ms-5 appear-animation" data-appear-animation="fadeInUp" alt="Etiquetado IMAQ">
                    </div>
