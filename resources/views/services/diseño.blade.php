@extends('index2')
@section('title','Diseño - IMAQ | Industrial Maquiladora OSC')
@section('content')
        ...
        <div class="row align-items-center justify-content-center pb-4 mb-5">
            <div class="col-lg-6 pb-sm-4 pb-lg-0 mb-5 mb-lg-0">
                <div class="overflow-hidden">
                    <h1 class="font-weight-bold text-color-dark line-height-1 mb-0 appear-animation animated maskUp appear-animation-visible" data-appear-animation="maskUp" data-appear-animation-delay="300" style="animation-delay: 300ms;">Diseño</h1>
                </div>
                ...
                <p class="text-color-dark text-3-5 mb-4 appear-animation animated fadeInUpShorter appear-animation-visible" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="450" style="animation-delay: 450ms;">El objetivo principal del área de diseño es crear y desarrollar el diseño de productos innovadores, atractivos y funcionales que satisfagan las necesidades de los consumidores.</p>
                <div class="d-flex align-items-center border border-top-0 border-end-0 border-start-0 pb-8 mb-4">
                    ...
                    <p class="text-color-dark text-3-5 mb-4 appear-animation animated fadeInUpShorter appear-animation-visible"><b class="text-color-dark">Investigación de tendencias: -</b> Se lleva a cabo una investigación de las tendencias del mercado y las necesidades de los consumidores para desarrollar productos que satisfagan esas necesidades.</p>
                </div>
                <div class="d-flex align-items-center border border-top-0 border-end-0 border-start-0 pb-8 mb-4">
                    <i class="fa fa-check text-color-primary bg-light rounded-circle box-shadow-4 p-2 me-3"></i>
                    <p class="text-color-dark text-3-5 mb-4 appear-animation animated fadeInUpShorter appear-animation-visible"><b class="text-color-dark">Creación de conceptos de diseño: -</b> Se desarrollan conceptos de diseño para los productos, que pueden incluir la forma, el color, la textura y los materiales.</p>
                </div>
                <div class="d-flex align-items-center border border-top-0 border-end-0 border-start-0 pb-8 mb-4">
                    <i class="fa fa-check text-color-primary bg-light rounded-circle box-shadow-4 p-2 me-3"></i>
                    <p class="text-color-dark text-3-5 mb-4 appear-animation animated fadeInUpShorter appear-animation-visible"><b class="text-color-dark">Creación de prototipos: -</b> Se crean prototipos de los productos para evaluar su funcionalidad y estética antes de su producción.</p>
                </div>
                <div class="d-flex align-items-center border border-top-0 border-end-0 border-start-0 pb-8 mb-4">
                    <i class="fa fa-check text-color-primary bg-light rounded-circle box-shadow-4 p-2 me-3"></i>
                    <p class="text-color-dark text-3-5 mb-4 appear-animation animated fadeInUpShorter appear-animation-visible"><b class="text-color-dark">Trabajo en equipo con otros departamentos: -</b> El área de diseño trabaja en estrecha colaboración con otros departamentos, como el de investigación y desarrollo, el de marketing y el de producción, para asegurarse de que los productos sean viables, rentables y comercialmente exitosos.</p>
                </div>
                <p class="text-color-dark text-3-5 mb-4 appear-animation animated fadeInUpShorter appear-animation-visible" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="700" style="animation-delay: 700ms;">En resumen, nuestro área de diseño se enfoca en desarrollar productos de belleza y cuidado personal innovadores, atractivos y funcionales que satisfagan las necesidades de los consumidores y que estén listos para su comercialización en el mercado.</p>
            ...
            <div class="col-10 col-md-9 col-lg-6 ps-lg-5 pe-5 appear-animation animated fadeInRightShorterPlus appear-animation-visible" data-appear-animation="fadeInRightShorterPlus" data-appear-animation-delay="1450" data-plugin-options="{'accY': -200}" style="animation-delay: 1450ms;">
                <div class="position-relative">
                    <div data-plugin-float-element="" data-plugin-options="{'startPos': 'top', 'speed': 0.2, 'transition': true, 'transitionDuration': 1000, 'isInsideSVG': true}" style="top: 0px; transition: transform 1000ms ease-out 0ms; transform: translate3d(0px, 9.07284%, 0px);">
                        <img src="img/landing/services/diseno.jpg" class="img-fluid border border-width-10 border-color-light rounded box-shadow-3 lazyload ms-5 appear-animation" data-appear-animation="fadeInUp" alt="Etiquetado IMAQ">
                    </div>
