@extends('index2')
@section('title','Etiquetado - IMAQ | Industrial Maquiladora OSC')
@section('content')
        ...
        <div class="row align-items-center justify-content-center pb-4 mb-5">
            <div class="col-lg-6 pb-sm-4 pb-lg-0 mb-5 mb-lg-0">
                <div class="overflow-hidden">
                    <h1 class="font-weight-bold text-color-dark line-height-1 mb-0 appear-animation animated maskUp appear-animation-visible" data-appear-animation="maskUp" data-appear-animation-delay="300" style="animation-delay: 300ms;">Etiquetado</h1>
                </div>
                ...
                <p class="text-color-dark text-3-5 mb-4 appear-animation animated fadeInUpShorter appear-animation-visible" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="450" style="animation-delay: 450ms;">Las etiquetas son un componente clave del marketing y la regulación de productos cosméticos, ya que proporcionan información esencial al consumidor, como los ingredientes, instrucciones de uso y precauciones.</p>
                <p class="text-color-dark text-3-5 mb-4 appear-animation animated fadeInUpShorter appear-animation-visible" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="700" style="animation-delay: 700ms;">Las etiquetas también deben ser atractivas y llamar la atención de los consumidores, lo que puede influir en la decisión de compra del cliente.</p>
                <p class="text-color-dark text-3-5 mb-4 appear-animation animated fadeInUpShorter appear-animation-visible" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="700" style="animation-delay: 900ms;">Otro aspecto importante es la selección de materiales de etiquetado adecuados que cumplan con los requisitos de la regulación y al mismo tiempo sean resistentes al agua, al calor y al desgaste. Es crucial seleccionar materiales de etiquetado duraderos y resistentes para garantizar que la información importante del producto no se borre ni se desvanezca con el tiempo.</p>
            ...
            <div class="col-10 col-md-9 col-lg-6 ps-lg-5 pe-5 appear-animation animated fadeInRightShorterPlus appear-animation-visible" data-appear-animation="fadeInRightShorterPlus" data-appear-animation-delay="1450" data-plugin-options="{'accY': -200}" style="animation-delay: 1450ms;">
                <div class="position-relative">
                    <div data-plugin-float-element="" data-plugin-options="{'startPos': 'top', 'speed': 0.2, 'transition': true, 'transitionDuration': 1000, 'isInsideSVG': true}" style="top: 0px; transition: transform 1000ms ease-out 0ms; transform: translate3d(0px, 9.07284%, 0px);">
                        <img src="img/landing/services/etiquetado.jpg" class="img-fluid border border-width-10 border-color-light rounded box-shadow-3 lazyload ms-5 appear-animation" data-appear-animation="fadeInUp" alt="Etiquetado IMAQ">
                    </div>
